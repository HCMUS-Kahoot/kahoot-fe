...
const createItemOptions = [
  {
    ...
    label: (
      <div className="flex bg-[F2F2F2] w-60 justify-between items-center">
        <Image src={require("../../assets/images/Kahoot.png")} preview={false}/>
      ...
      <Col className="h-full">
        <Row className="h-full">
          <Col className="h-full flex">
            <Link to="\" className="w-20 pt-2"><Image src={require("../../assets/images/Kahoot-Logo.png")} preview={false} className="self-center"/></Link>
          </Col>
          <Col className="h-full">
            <Navbar/>
          </Col>
        ...
        <Space direction="vertical">
          <Space wrap>
            <Dropdown
              ...
              placement="bottomRight">
              <Button shape="circle" icon={<UserOutlined/>} className="mr-4" size="large" />
            </Dropdown>
          </Space>
        </Space>
      </Col>
