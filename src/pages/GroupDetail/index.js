      ...
      <div className="mx-72">
        <div className="my-navbar">
          <Menu mode="horizontal" defaultActiveFirst>
            <Menu.Item key="mail">Posts</Menu.Item>

            <Menu.Item key="myGroup">Members</Menu.Item>
          </Menu>
        </div>
        <div className="body">
          <Row>
            <Col span={6}>
              <div className="m-4">
                ...
                >
                  <span className="text-2xl text-green-600 font-bold cursor-pointer ">
                    dhtpdt <ExpandOutlined className="relative bottom-2" />
                  </span>
                </Card>
              </div>
            </Col>
